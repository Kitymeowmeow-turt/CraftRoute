...
local function split_into_bands(steps, maxSkill)
	local banded = {}
...
local function build_report(professionKey, total_cost, steps, missing, reached, stuckAt, total_learn_cost, any_learn_cost_estimated, startSkill, candidates, chosen)
	...
	local banded = split_into_bands(steps, stuckAt or reached)
	local pathConsumed = {}
	local supply = nil
	local trueCost = 0
